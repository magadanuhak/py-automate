            ...
            for test in tests:
                ...
                for test_method in test_methods:
                    try:
                        ...
                        print(colored(emoji.emojize(" :check_mark:") + ' [U] Done: ',
                                      'green') + initializedTest.__module__ + "." + test_method)
                    except Exception as e:
                        print(colored(emoji.emojize(":cross_mark:") + " [U] Failed: ",
                                      'red') + initializedTest.__module__ + "." + test_method + str(e))
                ...
                for auth_test_method in auth_test_methods:
                    try:
                        ...
                        print(colored(emoji.emojize(" :check_mark:") + " [A]  Done: ",
                                      'green') + initializedTest.__module__ + "." + auth_test_method)
                    except Exception as e:
                        print(colored(emoji.emojize(" :cross_mark:") + " [A] Failed: ",
                                      'red') + initializedTest.__module__ + "." + auth_test_method + str(e))
